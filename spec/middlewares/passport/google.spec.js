...
import { findOrCreateUser } from "../../../app/middlewares/passport/google"
  ...
  describe("valid params given", () => {
    describe("without user", () => {
      it("should return user", async () => {
        ...
        expect(user).to.have.property("provider").eql("google")
        expect(user).to.have.property("google").eql(profile._json)
    ...
    describe("with user", () => {
      it("should return user", async () => {
        ...
        let user = await factory.create("user", { google: profile })
