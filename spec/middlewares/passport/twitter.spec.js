...
import { findOrCreateUser } from "../../../app/middlewares/passport/twitter"
  ...
  describe("valid params given", () => {
    describe("without user", () => {
      it("should return user", async () => {
        ...
        expect(user).to.have.property("provider").eql("twitter")
        expect(user).to.have.property("twitter").eql(profile._json)
    ...
    describe("with user", () => {
      it("should return user", async () => {
        ...
        let user = await factory.create("user", { twitter: profile })

        await findOrCreateUser(accessToken, refreshToken, profileSend, done)
